...
export default function ClubCardSkeleton() {
  return (
    <article className="flex h-full flex-col overflow-hidden border border-stone-200 bg-white" aria-hidden="true">
      ...
      <div className="flex flex-1 animate-pulse flex-col p-6">
        ...
        <div className="mt-4 h-[44px] space-y-2">
        ...
        <div className="mt-5 grid grid-cols-2 gap-x-4 gap-y-3 border-y border-stone-100 py-4">
          ...
          <div className="col-span-2 min-h-[40px]"><div className="h-2.5 w-12 bg-stone-200" /><div className="mt-2 h-4 w-full bg-stone-100" /></div>
        </div>

        <div className="mt-auto pt-5"><div className="h-10 w-full bg-stone-100" /></div>
      </div>
    </article>
  );
}
